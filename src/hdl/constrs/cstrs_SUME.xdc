...
create_clock -period 5.000 [get_ports FPGA_SYSCLK_P]
...
create_clock -period 4.290 [get_ports DDR3_SYSCLK_P]
...
#set_false_path -through [get_nets init_calib_complete]
...
#set_property -dict { PACKAGE_PIN BA19  IOSTANDARD LVCMOS15 } [get_ports { UART_RXD_OUT }]; #IO_L24N_T3_32 Sch=uart_rxd_out
#set_property -dict { PACKAGE_PIN AY19  IOSTANDARD LVCMOS15 } [get_ports { UART_TXD_IN }]; #IO_L24P_T3_32 Sch=uart_txd_in
...
#set_property -dict {PACKAGE_PIN L19 IOSTANDARD LVCMOS15} [get_ports ETH2_MOD_DETECT]
...
set_property -dict {PACKAGE_PIN L20 IOSTANDARD LVCMOS15} [get_ports ETH2_RX_LOS]
set_property -dict {PACKAGE_PIN B31 IOSTANDARD LVCMOS15} [get_ports ETH2_TX_DISABLE]
set_property -dict {PACKAGE_PIN C26 IOSTANDARD LVCMOS15} [get_ports ETH2_TX_FAULT]

##SFP ETH3 Misc.
set_property -dict {PACKAGE_PIN AY18 IOSTANDARD LVCMOS15} [get_ports {ETH3_LED[0]}]
set_property -dict {PACKAGE_PIN AY17 IOSTANDARD LVCMOS15} [get_ports {ETH3_LED[1]}]
#set_property -dict {PACKAGE_PIN J37 IOSTANDARD LVCMOS15} [get_ports ETH3_MOD_DETECT]
...
#set_property -dict {PACKAGE_PIN G37 IOSTANDARD LVCMOS15} [get_ports ETH3_RX_LOS]
#set_property -dict {PACKAGE_PIN J38 IOSTANDARD LVCMOS15} [get_ports ETH3_TX_DISABLE]
#set_property -dict {PACKAGE_PIN E39 IOSTANDARD LVCMOS15} [get_ports ETH3_TX_FAULT]

##SFP ETH4 Misc.
set_property -dict {PACKAGE_PIN P31 IOSTANDARD LVCMOS15} [get_ports {ETH4_LED[0]}]
set_property -dict {PACKAGE_PIN K32 IOSTANDARD LVCMOS15} [get_ports {ETH4_LED[1]}]
#set_property -dict {PACKAGE_PIN H36 IOSTANDARD LVCMOS15} [get_ports ETH4_MOD_DETECT]
...
#set_property -dict {PACKAGE_PIN J36 IOSTANDARD LVCMOS15} [get_ports ETH4_RX_LOS]
#set_property -dict {PACKAGE_PIN L21 IOSTANDARD LVCMOS15} [get_ports ETH4_TX_DISABLE]
#set_property -dict {PACKAGE_PIN J26 IOSTANDARD LVCMOS15} [get_ports ETH4_TX_FAULT]
...
set_false_path -to [get_ports ETH*_LED*]

set_output_delay 0.200 [get_ports ETH1_LED]
set_output_delay 0.200 [get_ports ETH*_TX_DISABLE]

set_output_delay 0.200 [get_ports ETH*_LED*]
set_input_delay 0.200 [get_ports ETH*_TX_FAULT]

#set_false_path -through [get_nets reset]
#set_false_path -through [get_pins reset_reg/D] 
#set_false_path -to [get_pins reset_reg/D]
#[get_pins reset_reg_rep/D] 
#[get_pins reset_reg_rep__0/D] 

set_input_delay 0.200 [get_ports {BTN[0]}]
set_input_delay 0.200 [get_ports ETH*_MOD_DETECT]
set_input_delay 0.200 [get_ports ETH*_RX_LOS]
set_input_delay 0.200 [get_ports ETH*_TX_FAULT]
...
#Button for reset is never used...

#set sfpclk [get_clocks -of_objects [get_ports SFP_CLK_P]]
set_false_path -to [get_ports ETH*_LED*]
set_false_path -to [get_ports ETH*_TX_DISABLE]
